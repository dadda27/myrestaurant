/*This page contains the scripts for the "Home" page (index.php) such as the images carousel.*/
...
/*Resets the counter of the carousel so images restart moving from the begin*/
